                        ...
                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M10 2a8 8 0 100 16 8 8 0 000-16zm6 8a6 6 0 01-5 5.917V13a1 1 0 00-.117-.465l-2-4A1 1 0 019.764 7h.472a1 1 0 01.881.535l2.38 4.76A5.98 5.98 0 0116 10zm-6-6a6 6 0 00-5 5.917V9a1 1 0 00.117-.465l2-4A1 1 0 0110.236 5h-.472a1 1 0 00-.881.535l-2.38 4.76A5.98 5.98 0 0110 4z"
                                        clip-rule="evenodd" />
                                </svg>
